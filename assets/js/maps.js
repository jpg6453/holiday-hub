...
function setAutocompleteCountry() {
    ...
    clearMarkers();
      ...
      // Listener for POI buttons
        var hotel = document.getElementById('hotel').addEventListener('click', checkHotels);
        var bar = document.getElementById('glass').addEventListener('click', checkBars);
        var restaurant = document.getElementById('restaurant').addEventListener('click', checkRestaurants);
        var attraction = document.getElementById('info').addEventListener('click', checkAttractions );
