      ...
      function addResult(result,i) {
            ...
            <div class="col-lg-12">
                ...
                <div class="card result-card">
                    <img src="${result.photos[0].getUrl()}" class="card-img-top result-img"/>
                    <div class="card-body">
                    <span>${i + 1}</span>
                    <span>${result.rating}</span>
					<h5 class="dest-card-title">${result.name}</h5>
                    <p class="dest-card-para">${result.vicinity}</p>
                    <p class="dest-card-para">Covid-19 Status:${result.rating} &#11088;</p>
				</div> 
                </div>
            </div> 
            `;
